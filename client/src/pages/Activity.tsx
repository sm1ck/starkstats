...
export const Activity = () => {
    ...
    /> : fetchData.data === undefined ? <div>{fetchData.error}</div> :
        <div className="victoryChart">
            <h3 className="textCenter">Статистика уникальных календарных дней по активности пользователей</h3>
            ...
            <h3 className="textCenter">Статистика уникальных календарных недель по активности пользователей</h3>
            <div className="textCenter">Наведите курсор на нужную часть графика</div>
            <VictoryChart domainPadding={20} padding={60}>
                <VictoryScatter
                    style={{ data: { fill: "#c43a31", stroke: "black", strokeWidth: 1 }, labels: { fontSize: 9 } }}
            ...
            <h3 className="textCenter">Статистика уникальных календарных месяцев по активности пользователей</h3>
            <div className="textCenter">Наведите курсор на нужную часть графика</div>
            <VictoryChart domainPadding={20} padding={60}>
                <VictoryScatter
                    style={{ data: { fill: "#c43a31", stroke: "black", strokeWidth: 1 }, labels: { fontSize: 9 } }}
