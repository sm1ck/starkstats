        ...
        <> <div className="victoryPie">
            ...
            <VictoryPie
                ...
                data={[
                    ...
                    { label: `0.5 ETH - 1 ETH ${t("more")} (${fetchData.data.bridgesVolume.lessThan1}, ${sumPercentWithTotal(fetchData.data.bridgesVolume.lessThan1, fetchData.data.bridgesVolume.lessThan5of1000 + fetchData.data.bridgesVolume.lessThan1of100 + fetchData.data.bridgesVolume.lessThan1of10 + fetchData.data.bridgesVolume.lessThan1of2 + fetchData.data.bridgesVolume.lessThan1)}%)`, x: fetchData.data.bridgesVolume.lessThan1, y: fetchData.data.bridgesVolume.lessThan1 },
                ]}
            /></div>
            ...
            <div className="victoryPie">
                ...
                <VictoryPie
                    ...
                    data={[
                        ...
                        { label: `0.5 ETH - 1 ETH ${t("more")} (${fetchData.data.bridgesWithCexVolume.lessThan1}, ${sumPercentWithTotal(fetchData.data.bridgesWithCexVolume.lessThan1, fetchData.data.bridgesWithCexVolume.lessThan5of1000 + fetchData.data.bridgesWithCexVolume.lessThan1of100 + fetchData.data.bridgesWithCexVolume.lessThan1of10 + fetchData.data.bridgesWithCexVolume.lessThan1of2 + fetchData.data.bridgesWithCexVolume.lessThan1)}%)`, x: fetchData.data.bridgesWithCexVolume.lessThan1, y: fetchData.data.bridgesWithCexVolume.lessThan1 },
                    ]}
                /></div>
        </>
};