    ...
    /> : fetchData.data === undefined ? <div>{fetchData.error}</div> :
        <> <div className="victoryPie">
            ...
            <VictoryPie
                ...
                data={[
                    { label: `Менее 0.005 ETH (${fetchData.data.bridgesVolume.lessThan5of1000}, ${sumPercentWithTotal(fetchData.data.bridgesVolume.lessThan5of1000, fetchData.data.bridgesVolume.lessThan5of1000 + fetchData.data.bridgesVolume.lessThan1of100 + fetchData.data.bridgesVolume.lessThan1of10 + fetchData.data.bridgesVolume.lessThan1of2 + fetchData.data.bridgesVolume.lessThan1)}%)`, x: fetchData.data.bridgesVolume.lessThan5of1000, y: fetchData.data.bridgesVolume.lessThan5of1000 },
                    { label: `0.005 ETH - 0.01 ETH (${fetchData.data.bridgesVolume.lessThan1of100}, ${sumPercentWithTotal(fetchData.data.bridgesVolume.lessThan1of100, fetchData.data.bridgesVolume.lessThan5of1000 + fetchData.data.bridgesVolume.lessThan1of100 + fetchData.data.bridgesVolume.lessThan1of10 + fetchData.data.bridgesVolume.lessThan1of2 + fetchData.data.bridgesVolume.lessThan1)}%)`, x: fetchData.data.bridgesVolume.lessThan1of100, y: fetchData.data.bridgesVolume.lessThan1of100 },
                    { label: `0.01 ETH - 0.1 ETH (${fetchData.data.bridgesVolume.lessThan1of10}, ${sumPercentWithTotal(fetchData.data.bridgesVolume.lessThan1of10, fetchData.data.bridgesVolume.lessThan5of1000 + fetchData.data.bridgesVolume.lessThan1of100 + fetchData.data.bridgesVolume.lessThan1of10 + fetchData.data.bridgesVolume.lessThan1of2 + fetchData.data.bridgesVolume.lessThan1)}%)`, x: fetchData.data.bridgesVolume.lessThan1of10, y: fetchData.data.bridgesVolume.lessThan1of10 },
            ...
            <div className="victoryPie">
                ...
                <VictoryPie
                    ...
                    data={[
                        { label: `Менее 0.005 ETH (${fetchData.data.bridgesWithCexVolume.lessThan5of1000}, ${sumPercentWithTotal(fetchData.data.bridgesWithCexVolume.lessThan5of1000, fetchData.data.bridgesWithCexVolume.lessThan5of1000 + fetchData.data.bridgesWithCexVolume.lessThan1of100 + fetchData.data.bridgesWithCexVolume.lessThan1of10 + fetchData.data.bridgesWithCexVolume.lessThan1of2 + fetchData.data.bridgesWithCexVolume.lessThan1)}%)`, x: fetchData.data.bridgesWithCexVolume.lessThan5of1000, y: fetchData.data.bridgesWithCexVolume.lessThan5of1000 },
                        { label: `0.005 ETH - 0.01 ETH (${fetchData.data.bridgesWithCexVolume.lessThan1of100}, ${sumPercentWithTotal(fetchData.data.bridgesWithCexVolume.lessThan1of100, fetchData.data.bridgesWithCexVolume.lessThan5of1000 + fetchData.data.bridgesWithCexVolume.lessThan1of100 + fetchData.data.bridgesWithCexVolume.lessThan1of10 + fetchData.data.bridgesWithCexVolume.lessThan1of2 + fetchData.data.bridgesWithCexVolume.lessThan1)}%)`, x: fetchData.data.bridgesWithCexVolume.lessThan1of100, y: fetchData.data.bridgesWithCexVolume.lessThan1of100 },
                        { label: `0.01 ETH - 0.1 ETH (${fetchData.data.bridgesWithCexVolume.lessThan1of10}, ${sumPercentWithTotal(fetchData.data.bridgesWithCexVolume.lessThan1of10, fetchData.data.bridgesWithCexVolume.lessThan5of1000 + fetchData.data.bridgesWithCexVolume.lessThan1of100 + fetchData.data.bridgesWithCexVolume.lessThan1of10 + fetchData.data.bridgesWithCexVolume.lessThan1of2 + fetchData.data.bridgesWithCexVolume.lessThan1)}%)`, x: fetchData.data.bridgesWithCexVolume.lessThan1of10, y: fetchData.data.bridgesWithCexVolume.lessThan1of10 },
